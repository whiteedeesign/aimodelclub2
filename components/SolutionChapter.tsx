      ...
      <div className="max-w-[720px] w-full mx-auto px-6 py-12 md:py-32 space-y-16 md:space-y-24">
        ...
        <section className="space-y-8 md:space-y-12">
          ...
          <div className="space-y-6 md:space-y-10">
            {[
              { s: "Шаг 1: Трафик", d: "Создание аккаунтов-крючков в Instagram, Threads, TikTok. Задача — вызвать желание увидеть больше." },
              { s: "Шаг 2: Переход", d: "Ссылка на воронку в профиле. Конвертируем любопытство в подписку." },
